...
function AdminNav() {
    ...
    return (
        <nav className="bg-[#282b40] shadow-xl sticky top-0 z-50 border-b-2 border-[#3a3f5c]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="relative hidden lg:block">
                        ...
                        {dropdownOpen && (
                            <div className="absolute right-0 mt-2 w-52 bg-[#282b40] rounded-none shadow-lg border border-cyan-100 py-2 z-50 animate-fadeIn">
